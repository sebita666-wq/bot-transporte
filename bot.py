...
print("🚀 INICIANDO BOT - VERSIÓN ORGANIZADA CON DEBUG")
...
try:
    ...
    try:
        ...
        print("✅ Zona horaria configurada: Argentina")
    except:
        timezone = pytz.timezone('America/Argentina/Cordoba')
        print("⚠️ Usando zona horaria alternativa: Córdoba")
...
print(f"✅ {len(FERIADOS_NACIONALES)} feriados cargados")
...
tramos_habiles = [
    ...
    # Parana 05:35 → Viale 06:45 → Tabossi 07:00 → (vuelve) Tabossi 07:00 → Viale 07:20 → Parana 08:30
    ...
    # Parana 06:40 → Aldea San Antonio 07:30 → Viale 07:50 → (vuelve) Viale 08:15 → Parana 09:25
    ...
    # Parana 07:45 → (R10) → Maria Grande 09:10 → (vuelve) Sosa 09:25 → Tabossi 09:45 → Viale 10:05 → Parana 11:15
    ...
    # Parana 08:45 → Viale 09:55 → Tabossi 10:10 → (vuelve) Tabossi 10:25 → Viale 10:45 → Parana 11:55
    ...
    # Parana 10:00 → Viale 11:10 → (vuelve) Viale 12:00 → Parana 13:10
    {"origen": "Parana", "destino": "Viale", "hora_salida": "10:00", "ruta": "R18"},
    {"origen": "Viale", "destino": "Parana", "hora_salida": "12:00", "ruta": "R18"},
    
    # Parana 10:15 → (R10) → Maria Grande 11:40 → (vuelve) Sosa 11:55 → Tabossi 12:15 → Viale 12:35 → Aldea San Antonio 12:55 → Parana 13:45
    ...
    # Parana 12:15 → Viale 13:25 → (vuelve) Viale 13:30 → Parana 14:40
    {"origen": "Parana", "destino": "Viale", "hora_salida": "12:15", "ruta": "R18"},
    {"origen": "Viale", "destino": "Parana", "hora_salida": "13:30", "ruta": "R18"},
    
    # Parana 13:05 → Viale 14:15 → Tabossi 14:30 → Sosa 14:45 → Maria Grande 15:05 → (vuelve R10) → Parana 16:35
    ...
    # Parana 14:00 → Viale 15:10 → (vuelve) Viale 15:40 → Parana 16:50
    {"origen": "Parana", "destino": "Viale", "hora_salida": "14:00", "ruta": "R18"},
    {"origen": "Viale", "destino": "Parana", "hora_salida": "15:40", "ruta": "R18"},
    
    # Parana 15:30 → Viale 16:40 → Tabossi 16:55 → (vuelve) Tabossi 17:00 → Viale 17:30 → Parana 18:25
    ...
    # Parana 16:30 → (R10) → Maria Grande 18:00 → (vuelve) Sosa 18:15 → Tabossi 18:35 → Viale 18:55 → Parana 20:05
    ...
    # Parana 17:15 → Viale 18:25 → Tabossi 18:40 → Sosa 18:55 → Maria Grande 19:15 → (vuelve R10) → Parana 20:45
    ...
    # Parana 18:00 → Viale 19:10 → (vuelve) Viale 19:40 → Parana 20:50
    {"origen": "Parana", "destino": "Viale", "hora_salida": "18:00", "ruta": "R18"},
    {"origen": "Viale", "destino": "Parana", "hora_salida": "19:40", "ruta": "R18"},
    
    # Parana 19:30 → Viale 20:40 → (vuelve) Viale 21:10 → Parana 22:20
    {"origen": "Parana", "destino": "Viale", "hora_salida": "19:30", "ruta": "R18"},
    {"origen": "Viale", "destino": "Parana", "hora_salida": "21:10", "ruta": "R18"},
    
    # Parana 20:45 → Viale 21:55 → Tabossi 22:10 → Sosa 22:25 → Maria Grande 22:45 → (vuelve) Sosa 23:00 → Tabossi 23:15 → Viale 23:30 → Parana 00:30
    ...
    # Parana 23:00 → Viale 00:10
    {"origen": "Parana", "destino": "Viale", "hora_salida": "23:00", "ruta": "R18"},
]

print(f"✅ {len(tramos_habiles)} tramos de días hábiles cargados")
...
tramos_sabados = [
    # Tabossi 06:15 → Viale 06:30 → Parana 07:30
    {"origen": "Tabossi", "destino": "Viale", "hora_salida": "06:15", "ruta": "R18"},
    {"origen": "Viale", "destino": "Parana", "hora_salida": "06:30", "ruta": "R18"},
    
    # Parana 04:45 → Viale 05:50 → Tabossi 06:10 → Sosa 06:25 → Maria Grande 06:45 → (vuelve R10) → Parana 08:15
    {"origen": "Parana", "destino": "Viale", "hora_salida": "04:45", "ruta": "R18"},
    {"origen": "Viale", "destino": "Tabossi", "hora_salida": "05:50", "ruta": "R18"},
    {"origen": "Tabossi", "destino": "Sosa", "hora_salida": "06:10", "ruta": "R18"},
    {"origen": "Sosa", "destino": "Maria Grande", "hora_salida": "06:25", "ruta": "R18"},
    ...
    # Parana 05:35 → Viale 06:45 → Tabossi 06:55 → (vuelve) Tabossi 07:00 → Viale 07:20 → Parana 08:30
    {"origen": "Parana", "destino": "Viale", "hora_salida": "05:35", "ruta": "R18"},
    {"origen": "Viale", "destino": "Tabossi", "hora_salida": "06:45", "ruta": "R18"},
    {"origen": "Tabossi", "destino": "Viale", "hora_salida": "07:00", "ruta": "R18"},
    {"origen": "Viale", "destino": "Parana", "hora_salida": "07:20", "ruta": "R18"},
    
    # Parana 07:45 → (R10) → Maria Grande 11:40 → (vuelve) Sosa 12:00 → Tabossi 12:20 → Viale 12:40 → Parana 13:45
    {"origen": "Parana", "destino": "Maria Grande", "hora_salida": "07:45", "ruta": "R10"},
    ...
    # Parana 11:40 → Viale 12:50 → (vuelve) Viale 13:30 → Parana 14:40
    {"origen": "Parana", "destino": "Viale", "hora_salida": "11:40", "ruta": "R18"},
    {"origen": "Viale", "destino": "Parana", "hora_salida": "13:30", "ruta": "R18"},
    
    # Parana 12:30 → Viale 13:50 → Tabossi 14:10 → Sosa 14:30 → Maria Grande 14:50 → (vuelve R10) → Parana 16:15
    ...
    # Parana 14:00 → Viale 15:00 → (vuelve) Viale 15:15 → Parana 16:15
    {"origen": "Parana", "destino": "Viale", "hora_salida": "14:00", "ruta": "R18"},
    {"origen": "Viale", "destino": "Parana", "hora_salida": "15:15", "ruta": "R18"},
    
    # Parana 15:15 → Viale 16:20 → Tabossi 16:35 → (vuelve) Tabossi 16:40 → Viale 17:00 → Parana 18:10
    ...
    # Parana 17:00 → Viale 18:10 → Tabossi 18:30 → Sosa 18:45 → Maria Grande 19:05 → (vuelve R10) → Parana 20:30
    ...
    # Parana 16:30 → (R10) → Maria Grande 18:00 → (vuelve) Sosa 18:20 → Tabossi 18:40 → Viale 19:00 → Parana 20:10
    {"origen": "Parana", "destino": "Maria Grande", "hora_salida": "16:30", "ruta": "R10"},
    ...
    # Parana 19:30 → Viale 20:40 → (vuelve) Viale 21:10 → Parana 22:15
    {"origen": "Parana", "destino": "Viale", "hora_salida": "19:30", "ruta": "R18"},
    {"origen": "Viale", "destino": "Parana", "hora_salida": "21:10", "ruta": "R18"},
    
    # Parana 20:45 → Viale 21:55 → Tabossi 22:15 → Sosa 22:30 → Maria Grande 22:45 → (vuelve) Sosa 23:00 → Tabossi 23:15 → Viale 23:30 → Parana 00:30
    {"origen": "Parana", "destino": "Viale", "hora_salida": "20:45", "ruta": "R18"},
    {"origen": "Viale", "destino": "Tabossi", "hora_salida": "21:55", "ruta": "R18"},
    ...
    # Parana 23:00 → Viale 00:01
    {"origen": "Parana", "destino": "Viale", "hora_salida": "23:00", "ruta": "R18"},
]

print(f"✅ {len(tramos_sabados)} tramos de sábados cargados")
...
tramos_domingos = [
    # Parana 07:15 → Viale 08:30 → (vuelve) Viale 08:45 → Parana 09:55
    {"origen": "Parana", "destino": "Viale", "hora_salida": "07:15", "ruta": "R18"},
    {"origen": "Viale", "destino": "Parana", "hora_salida": "08:45", "ruta": "R18"},
    
    # Parana 07:45 → (R10) → Maria Grande 09:10 → (vuelve) Sosa 09:34 → Tabossi 09:48 → Viale 10:07 → Parana 11:35
    {"origen": "Parana", "destino": "Maria Grande", "hora_salida": "07:45", "ruta": "R10"},
    ...
    # Parana 10:15 → Viale 11:45 → (vuelve) Viale 12:00 → Parana 13:10
    {"origen": "Parana", "destino": "Viale", "hora_salida": "10:15", "ruta": "R18"},
    {"origen": "Viale", "destino": "Parana", "hora_salida": "12:00", "ruta": "R18"},
    
    # Parana 12:30 → Viale 13:59 → Tabossi 14:15 → Sosa 14:30 → Maria Grande 14:50 → (vuelve R10) → Parana 16:25
    {"origen": "Parana", "destino": "Viale", "hora_salida": "12:30", "ruta": "R18"},
    ...
    # Parana 15:15 → Viale 16:25 → Tabossi 16:45 → (vuelve) Tabossi 16:50 → Viale 17:10 → Parana 18:40
    {"origen": "Parana", "destino": "Viale", "hora_salida": "15:15", "ruta": "R18"},
    ...
    # Parana 17:00 → Viale 18:29 → Tabossi 18:45 → Sosa 19:00 → Maria Grande 19:25 → (vuelve R10) → Parana 20:55
    {"origen": "Parana", "destino": "Viale", "hora_salida": "17:00", "ruta": "R18"},
    ...
    # Parana 19:00 → Viale 20:30 → (vuelve) Viale 20:45 → Parana 22:15
    {"origen": "Parana", "destino": "Viale", "hora_salida": "19:00", "ruta": "R18"},
    {"origen": "Viale", "destino": "Parana", "hora_salida": "20:45", "ruta": "R18"},
    
    # Parana 21:00 → Viale 22:10 → Tabossi 22:50 → (vuelve) Tabossi 22:50 → Viale 23:08 → Parana 00:05
...
print(f"✅ {len(tramos_domingos)} tramos de domingos cargados")
...
def ultimo_colectivo(origen, destino, tipo_dia):
    ...
    if resultados["R18"]:
        ...
        if not ultimo or r18_min > ultimo_min:
            ultimo = r18_ultimo
            ultimo_ruta = "R18"
            ultimo_min = r18_min
...
print("✅ Funciones de búsqueda cargadas")
...
print("✅ Funciones de respuesta cargadas")
...
def whatsapp_reply():
    try:
        ...
        if contexto.get("estado") == "esperando_origen_horarios":
            ...
            # Verificar si el mensaje es sobre PRECIO
